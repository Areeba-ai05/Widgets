        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                Container(
                  child: Text('n Flutter, icons are visual symbols used to represent common actions, concepts, or statuses. They are usually displayed using the Icon widget..', style:TextStyle(fontSize:18,fontWeight: FontWeight.w100, color:Colors.teal),),
                ),
                SizedBox(height: 20,),
                Row(
                  children: [
