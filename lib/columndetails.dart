        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                Container(
                  child: Text('The Column widget in Flutter is a layout widget that arranges its child widgets vertically in a column.Its similar to the Row widget but works along the vertical axis.', style:TextStyle(fontSize:18,fontWeight: FontWeight.w100, color:Colors.teal),),
                ),
                SizedBox(height: 20,),
                Row(
                  children: [
                    Text('Properties of Column:',style:TextStyle(fontSize:28,fontWeight: FontWeight.bold, color:Colors.black),),
                  ],),
                SizedBox(height: 20,),
